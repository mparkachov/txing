...
mod cyberbrick 'devices/cyberbrick/justfile'
mod cloud-mcu 'devices/cloud-mcu/justfile'
mod weather 'devices/weather/justfile'
mod power 'devices/power/justfile'
mod power-si 'devices/power-si/justfile'
mod power-nrf 'devices/power-nrf/justfile'
mod tbot 'devices/tbot/justfile'
mod mac 'devices/mac/justfile'
