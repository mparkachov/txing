...
2. Change power-si firmware to use stock Zephyr/OpenThread SED behavior with a 5000 ms poll period and no steady-state application override leaving the device receiver-on after SRP bootstrap.
