...
mod tests {
    ...
    fn topic_parsing_uses_v2_root() {
        assert_eq!(
            build_capability_state_topic("weather-1", "weather-ble-main").unwrap(),
            "dev/txing/rig/v2/capability/state/weather-1/weather-ble-main"
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            Some(("weather-1", "weather-ble-main"))
        );
        assert_eq!(
            parse_capability_heartbeat_topic(
                "dev/txing/rig/v2/capability/heartbeat/weather-ble-main"
            ),
            Some("weather-ble-main")
        );
    }
