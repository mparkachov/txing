...
class VersionEnvironmentTests(unittest.TestCase):
    ...
    def test_stable_release_publishes_only_project_assets(self) -> None:
        ...
        self.assertIn('-v "$RUNNER_TEMP:/out"', workflow)
        ...
        self.assertIn('install -m 755 devices/unit/board/kvs_master/build/txing-board-kvs-master "/out/$KVS_MASTER_BINARY"', workflow)
        self.assertIn('package_binary "$RUNNER_TEMP/txing-board-kvs-master"', workflow)
