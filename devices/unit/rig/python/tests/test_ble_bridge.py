...
class AwsShadowClientTests(unittest.TestCase):
    ...
    def test_justfile_install_service_uses_greengrass_supervision(self) -> None:
        ...
        self.assertIn('resolved_component_version="${TXING_RIG_COMPONENT_VERSION:-{{component_version}}}"', justfile)
        self.assertIn("rig::deploy arguments are positional", justfile)
        self.assertIn("TXING_RIG_COMPONENT_VERSION=0.5.1 just rig::deploy", justfile)
