...
// 
	...
	MAV_CMD_DO_SET_RELAY = 181, // Set a relay to a condition. The current value may optionally be reported using RELAY_STATUS.
...
// 
	...
	MAV_CMD_CAN_FORWARD = 32000, // Request forwarding of CAN packets from the given CAN bus to this component via this MAVLink channel. CAN Frames are sent using CAN_FRAME and CANFD_FRAME messages
	...
	MAV_CMD_GUIDED_CHANGE_HEADING = 43002, // Change to target direction at a given rate, overriding previous heading/s. This slews the vehicle at a controllable rate between its previous heading and the new one.
