#ifndef TXING_CYBERBRICK_HARDWARE_WORKER_CONFIG_HPP
#define TXING_CYBERBRICK_HARDWARE_WORKER_CONFIG_HPP
...
struct RuntimeConfig {
    std::string socket_path = "/run/txing-cyberbrick-hardware-worker/cyberbrick-hardware.sock";
    MotorConfig motor;
};
