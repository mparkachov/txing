...
const (
	SchemaVersion                 = "2.0"
	AdapterID                     = "dev.txing.cyberbrick.Daemon"
	...
	DefaultConfigSubdir           = "txing/cyberbrick-daemon"
	...
	DefaultKVSMasterCommand       = "txing-cyberbrick-kvs-master"
	DefaultMCPWebRTCSocketPath    = "/run/txing-cyberbrick-daemon/mcp-webrtc.sock"
	DefaultBoardVideoBridgeSocket = "/run/txing-cyberbrick-daemon/board-video-bridge.sock"
	DefaultHardwareSocketPath     = "/run/txing-cyberbrick-hardware-worker/cyberbrick-hardware.sock"
...
func ParseCLI(args []string) (CLI, error) {
	var cli CLI
	flags := flag.NewFlagSet("txing-cyberbrick-daemon", flag.ContinueOnError)
