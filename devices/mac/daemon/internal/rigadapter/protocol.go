// Package rigadapter speaks the rig local IPC capability contract.
//
// This file is a copied subset of rig/internal/protocol/protocol.go
// (schema 2.0). The rig module's internal packages cannot be imported
// across modules; the wire format below must stay byte-compatible with
// the rig source. When the rig protocol changes, update this copy and
// the golden tests in protocol_test.go together.
package rigadapter
