...
- This subproject is for XIAO nRF54L15 BLE idle/wakeup power measurements.
- Advertising-only profiles and the `gatt-1280-*` wake/sleep debug profiles are in scope.
